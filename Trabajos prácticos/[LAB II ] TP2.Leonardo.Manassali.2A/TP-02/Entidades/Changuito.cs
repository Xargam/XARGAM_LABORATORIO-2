...
namespace Entidades2018
{
    ...
    public sealed class Changuito
    {
		...
		/// <summary>
		/// Inicializa la lista de productos y el espacio disponible.
		/// </summary>
		/// <param name="espacioDisponible">Cantidad máxima de productos.</param>
		...
		/// <summary>
		/// Especifica el tipo de producto a mostrar o todos los tipos son mostrados.
		/// </summary>
		public enum ETipo
		{
			Dulce,
